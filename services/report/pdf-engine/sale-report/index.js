...
var _SaleTable = _interopRequireDefault(require("./SaleTable.js"));
...
function StockReport({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_renderer.Document, {
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_renderer.Page, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_renderer.Text, {
      ...
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)(_renderer.View, {
        style: {
          marginVertical: 10
        },
        children: data.during && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_renderer.Text, {
          ...
          children: ["Sale Duration: ", (0, _moment.default)(data.during.from).format('DD-MM-YYYY'), " to ", (0, _moment.default)(data.during.to).format('DD-MM-YYYY')]
        })
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_SaleTable.default, {
        sales: data.sales
